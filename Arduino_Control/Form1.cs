...
namespace Arduino_Control
{
    public partial class Form1 : Form
    {
        ...
        {
            this.ActiveControl = ArduinoUnoAbout;
            loadPinList();
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    if (Gvar.count > 1)
                    {
                        ...
                        pf.button1.Hide();
                        pf.Browse_avrdude.Hide();
                        pf.Browse_avrconfig.Hide();
                        pf.label2.Hide();
                        pf.label3.Hide();
                        pf.AvrdudePath_tb.Hide();
                        pf.AvrConfigPath_tb.Hide();
        ...
        private void ArduinoUnoAbout_Click(object sender, EventArgs e)
        {
            ArduinoUno_About form = new ArduinoUno_About();
            form.ShowDialog();
        }
